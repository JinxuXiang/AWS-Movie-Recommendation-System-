...
def lambda_handler(event, context):
    ...
    print("key:", key)
    print("value:", value)
    sql = "SELECT r.userId, u.userName, r.movieId, m.movieName FROM recommended_movies r JOIN movies m ON r.movieId = m.movieId JOIN users u ON r.userId = u.userId WHERE {0} = '{1}' ".format(key, value)
    print(sql)
